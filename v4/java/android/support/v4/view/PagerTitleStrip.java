...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        final int prevLeft = isLayoutRtl ?
                Math.max(stripWidth - paddingRight - prevWidth, currRight + mScaledTextSpacing) :
        ...
        final int nextLeft = isLayoutRtl ?
                Math.min(paddingLeft, currLeft - mScaledTextSpacing - nextWidth) :
    ...
    private class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener,
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            if (positionOffset > 0.5f) {
                ...
                if (ViewCompat.isLayoutRtl(PagerTitleStrip.this)) {
                    position--;
                } else {
                    position++;
                }
